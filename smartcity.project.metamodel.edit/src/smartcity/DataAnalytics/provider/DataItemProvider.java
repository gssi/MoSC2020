...
/**
 * This is the item provider adapter for a {@link smartcity.DataAnalytics.Data} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataAnalyticsPackage.Literals.DATA__NAME,
				 true,
				 false,
				 false,
	...
	protected void addUnitPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Data_unit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Data_unit_feature", "_UI_Data_type"),
				 DataAnalyticsPackage.Literals.DATA__UNIT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addSrcPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Data_src_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Data_src_feature", "_UI_Data_type"),
				 DataAnalyticsPackage.Literals.DATA__SRC,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Data.class)) {
			case DataAnalyticsPackage.DATA__NAME:
			case DataAnalyticsPackage.DATA__UNIT:
