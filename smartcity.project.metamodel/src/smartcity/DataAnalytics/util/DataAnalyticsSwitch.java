 ...
 * @generated
 */
public class DataAnalyticsSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DataAnalyticsPackage.DATA: {
			...
			case DataAnalyticsPackage.REAL_VALUE: {
				...
				if (result == null) result = caseData(realValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DataAnalyticsPackage.BOOL_VALUE: {
				...
				if (result == null) result = caseData(boolValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DataAnalyticsPackage.INTEGER_VALUE: {
				...
				if (result == null) result = caseData(integerValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case DataAnalyticsPackage.SOURCE: {
			...
			case DataAnalyticsPackage.SOCIAL_MEDIA: {
				...
				if (result == null) result = caseSource(socialMedia);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DataAnalyticsPackage.OPEN_DATA: {
				OpenData openData = (OpenData)theEObject;
				T result = caseOpenData(openData);
				if (result == null) result = caseSource(openData);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DataAnalyticsPackage.PROVIDED_DATA: {
				ProvidedData providedData = (ProvidedData)theEObject;
				T result = caseProvidedData(providedData);
				if (result == null) result = caseSource(providedData);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Open Data</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Open Data</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOpenData(OpenData object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Provided Data</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Provided Data</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseProvidedData(ProvidedData object) {
		return null;
	}
